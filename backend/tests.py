...
class AsgiTestCase(TestCase):
    """Testing correctly set environment variable and correct type of the ASGIHandler"""
    def test_environment_variable(self):
        self.assertEqual(os.environ["DJANGO_SETTINGS_MODULE"], "backend.settings")
        self.assertEqual(type(asgi_application), ASGIHandler)


class WsgiTestCase(TestCase):
    """Testing correctly set environment variable and correct type of the WSGIHandler"""
    def test_environment_variable(self):
        self.assertEqual(os.environ["DJANGO_SETTINGS_MODULE"], "backend.settings")
